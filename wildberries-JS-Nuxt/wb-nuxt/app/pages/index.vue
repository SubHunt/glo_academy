                    ...
                    <div class="row">
                        <div class="col-lg-4 col-10 offset-lg-1">
                            ...
                            <h2 class="slide-title">
                                Women's Alpargata Loafer
                            </h2>
                            <p class="slide-description">
                                At Alpa believe in a better tomorrow, one where
                                humanity thrives.
                            </p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-10 offset-lg-1">
                            ...
                            <p class="slide-description">
                                Women’s pearl basic knit sweater with a round
                                neck. Available in several colours. Free
                                shipping to stores.
                            </p>
        ...
        <div class="row mb-4">
            <div class="col-xl-6">
                <div class="card card-1 mb-4">
                    ...
                    <p class="card-text">
                        Bags & Acsessories & Lingerie & Sportswear & Beauty &
                        Swimwear
                    </p>
                    <button class="button">
            ...
            <div class="col-xl-6">
                <div class="card card-2 mb-4">
                    ...
                    <p class="card-text text-light">
                        Sweaters & Hoodies & Puffer Jackets & Coats and Jackets
                        & Knit
                    </p>
                    <button class="button">
                        <span class="button-text">View all</span>
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card card-4">
                    ...
                    <button
                        class="button add-to-cart button-four"
                        data-id="009"
                    >
                        <span class="button-price">$119</span>
                        <span class="button-text">Shop now</span>
